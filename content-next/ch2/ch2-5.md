...
Notice that PrintReport calls GetGrade. Execution moves to GetGrade, computes the grade, returns, and PrintReport continues. We traced this kind of call in the methods section.
...
In [Chapter 3 - Arrays](../ch3/index.md), we apply these same five questions to collections of values.

<div style="display: flex; justify-content: space-between; margin-top: 2rem;">
  <div style="text-align: left;">

**Previous:** [Section 4 - Methods](ch2-4.md)
  </div>
  <div style="text-align: right;">

**Next:** [Chapter 3 - Arrays](../ch3/index.md)
  </div>
</div>

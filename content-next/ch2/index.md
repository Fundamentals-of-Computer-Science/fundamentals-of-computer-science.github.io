---
title: Chapter 2 - Integers and Doubles
draft: false
permalink: ch2
---
...
1. **[Data and Memory](ch2-1.md):** How C# represents numbers and how we store them
2. **[Computation](ch2-2.md):** How we transform numeric values through arithmetic and comparison
3. **[Control Flow](ch2-3.md):** How numeric comparisons drive branching, loops, and input validation
4. **[Methods](ch2-4.md):** How we package numeric computations into named, reusable methods
5. **[Custom Types](ch2-5.md):** How we group related numeric data into structs

We begin with [Section 1 - Data and Memory](ch2-1.md): how does C# represent numbers?

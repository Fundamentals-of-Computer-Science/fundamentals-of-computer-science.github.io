  ...
  React.useLayoutEffect(() => {
    ...
    try {
      ...
      if (s && Number.isFinite(s.x) && Number.isFinite(s.y) && Number.isFinite(s.scale)) {
        ...
        apply();
        // Validate that the saved position actually shows content on screen.
        // If the world rect doesn't intersect the viewport at all, reset to
        // a sensible default so the user doesn't land on a blank canvas.
        requestAnimationFrame(() => {
          ...
          const visible = !(wR.right < vpR.left || wR.left > vpR.right ||
                            wR.bottom < vpR.top || wR.top > vpR.bottom);
          if (!visible) {

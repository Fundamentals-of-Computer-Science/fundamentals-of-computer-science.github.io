...
const CH2_LOOP_GOALS = {
  cycle: {
    id: 'cycle',
    n: 'A',
    label: 'Trace the loop control cycle',
    gloss: 'Follow the initialization, condition checks, body work, progress updates, and exit as one complete control-flow goal.',
  },
};

const CH2_LOOP_SUBGOALS = {
  init: {
    id: 'init',
    n: 'a',
    goal: 'cycle',
    label: 'Establish the initial state',
    gloss: 'Create count and give it a starting value of 0.',
  },
  check: {
    id: 'check',
    n: 'b',
    goal: 'cycle',
    label: 'Evaluate the continuation check',
    gloss: 'Ask whether the loop body should run again.',
  },
  work: {
    id: 'work',
    n: 'c',
    goal: 'cycle',
    label: 'Execute the core work',
    gloss: 'Print the current value of count.',
  },
  advance: {
    id: 'advance',
    n: 'd',
    goal: 'cycle',
    label: 'Advance the loop state',
    gloss: 'Change count so the condition can eventually become false.',
  },
  after: {
    id: 'after',
    n: 'e',
    goal: 'cycle',
    label: 'Continue after the loop',
    gloss: 'Run once the condition is finally false.',
  },
};

const CH2_LOOP_CODE = {
  layout: 'frame',
  goals: CH2_LOOP_GOALS,
  subgoals: CH2_LOOP_SUBGOALS,
  frame: [
...
const CH2_LOOP_TRACE_STEPS = [
  {
    id: 'loop-trace-init',
    label: 'line 1',
    sourceLabel: 'initialize count',
    rowKey: 'loop-line-1',
    subgoal: 'init',
    goal: 'cycle',
    phase: 'Initialize',
    note: 'Create count and start it at 0 before the first condition check.',

...
This chapter introduces C#'s two main numeric types: integers for whole numbers and doubles for decimals. We will start by understanding what these types are and how C# stores them. Then we will learn to compute with them, combining and transforming numeric values. By the end, we will connect numbers back to the boolean logic from Chapter 1, using numeric comparisons to control program behavior.

We begin with a fundamental question: how does C# represent numbers?
...
**Previous:** [Chapter 1 - Control Flow](../ch1/ch1-5.md)
  </div>
